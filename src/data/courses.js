export const courses = [
  {
    ...
    audience: [
      ...
      'Business owners who want cleaner data and faster decisions',
    ],
    learn: [
      'Formula mastery for real business reporting',
      'Lookup functions including VLOOKUP, XLOOKUP, INDEX, and MATCH',
  ...
  },
  {
    ...
    audience: [
      ...
      'Professionals who work with sales, finance, or operations data',
    ],
    learn: [
      'Power Query for data import, cleaning, and transformation',
      'Data modeling with relationships and star schema basics',
      'DAX measures for business calculations',
      'Dashboard designing with clean visual hierarchy',
  ...
  },
  {
    ...
    audience: [
      ...
      'Learners who want practical JavaScript automation skills',
    ],
    learn: [
      'Google Sheets automation with Apps Script',
      'Custom menus, buttons, and user-friendly workflows',
      'Web apps with doGet and doPost basics',
      'Email automation for alerts, reports, and confirmations',
